...
export default function about() {
  return (
    <div className='aboutbox'>
        <p>Welcome to ParkAndPay</p>
        <h4>At ParkAndPay, we understand that parking can often be a stressful and time-consuming experience, especially in busy urban areas. That's why we're here to make parking as easy and convenient as possible, with a range of innovative solutions designed to meet your parking needs.
...
Thank you for choosing ParkAndPay for all your parking needs. We're committed to providing you with the best possible parking experience, and we look forward to serving you!</h4>
